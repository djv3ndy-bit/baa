...
export function AppBottomNav({active,role='barista'}:{active:Tab;role?:'barista'|'cafe_owner_manager'}){
  const items=[{key:'home' as Tab,icon:'⌂',label:'Home',path:'/home'},{key:'discover' as Tab,icon:'⌕',label:'Discover',path:'/discover'},{key:'matches' as Tab,icon:'♡',label:'Matches',path:'/matches'},{key:'messages' as Tab,icon:'✉',label:'Messages',path:'/messages'},{key:'profile' as Tab,icon:'◯',label:'Profile',path:'/profile'}];
