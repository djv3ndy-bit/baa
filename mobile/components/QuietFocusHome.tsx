...
const styles = StyleSheet.create({
  ...
  refreshRetry: { fontSize: 14, color: prism.accent, fontWeight: '700', paddingTop: 12, minHeight: 44 },
  ...
  brand: { flexShrink: 1, minWidth: 0, color: prism.ink, fontSize: 19, fontWeight: '700', letterSpacing: -0.5 },
  ...
  eyebrow: { color: prism.muted, fontSize: 11, fontWeight: '700', letterSpacing: 1.3 },
  greeting: { color: prism.ink, fontSize: 29, lineHeight: 35, fontWeight: '700', letterSpacing: -0.9, marginTop: 8 },
  ...
  featureEyebrow: { color: prism.accent, fontSize: 11, lineHeight: 15, fontWeight: '700', letterSpacing: 0.9, marginBottom: 9 },
  featureTitle: { color: prism.ink, fontSize: 24, lineHeight: 28, fontWeight: '700', letterSpacing: -0.6 },
  featureSubtitle: { color: prism.muted, fontSize: 12, lineHeight: 18, marginTop: 9 },
  featureButton: { paddingHorizontal: 14, paddingVertical: 13, minHeight: 46, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: prism.accent },
  featureButtonText: { textAlign: 'center', flexShrink: 1, color: prism.surface, fontSize: 14, lineHeight: 20, fontWeight: '700' },
  sectionRow: { flexDirection: 'row', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: 13 },
  sectionTitle: { color: prism.ink, fontSize: 18, fontWeight: '700', letterSpacing: -0.3 },
  ...
  activityValue: { color: prism.ink, fontSize: 23, lineHeight: 28, fontWeight: '700', letterSpacing: -0.5 },
  ...
  planBadge: { flexShrink: 0, width: 42, minHeight: 42, paddingVertical: 7, borderRadius: 14, backgroundColor: prism.accentSoft, alignItems: 'center', justifyContent: 'center' },
  planBadgeText: { color: prism.accent, fontSize: 22, fontWeight: '700' },
  planBody: { flex: 1, minWidth: 0, paddingHorizontal: 12 },
  planEyebrow: { color: prism.muted, fontSize: 11, lineHeight: 15, fontWeight: '700', letterSpacing: 0.8 },
  planNameRow: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', gap: 7, marginTop: 5 },
  planName: { color: prism.ink, fontSize: 20, lineHeight: 26, fontWeight: '700' },
  activePill: { overflow: 'hidden', color: prism.accent, backgroundColor: prism.selected, borderRadius: 8, fontSize: 9, fontWeight: '700', paddingHorizontal: 7, paddingVertical: 4 },
  ...
  actionRowTitle: { color: prism.ink, fontSize: 15, lineHeight: 21, fontWeight: '700' },
  ...
  profileEyebrow: { color: prism.muted, fontSize: 11, fontWeight: '700', letterSpacing: 1 },
  profileTitle: { color: prism.ink, fontSize: 23, lineHeight: 29, fontWeight: '700', letterSpacing: -0.4, marginTop: 7 },
  ...
  progressFill: { height: '100%', borderRadius: 6, backgroundColor: prism.accent },
