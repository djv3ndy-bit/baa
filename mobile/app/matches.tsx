...
const s = StyleSheet.create({ safe: { flex: 1, backgroundColor: prism.background }, header: { padding: 20, paddingBottom: 10 }, title: { fontSize: 31, fontWeight: '500', color: prism.ink }, sub: { fontSize: 14, color: prism.muted, marginTop: 4 }, list: { padding: 18, paddingBottom: 30 }, refresh: { minHeight: 44, padding: 12, borderWidth: 1, borderColor: prism.line, borderRadius: 12, marginBottom: 14, marginTop: 10 }, row: { ...prismPanel, flexDirection: 'row', alignItems: 'center', gap: 13, backgroundColor: prism.surface, borderWidth: 1, borderColor: prism.line, borderRadius: 22, padding: 15, marginBottom: 10 }, name: { fontSize: 16, fontWeight: '600', color: prism.ink }, meta: { fontSize: 12, color: prism.muted, marginTop: 4 }, chev: { fontSize: 29, color: prism.accent }, empty: { alignItems: 'center', paddingTop: 65 }, emptyTitle: { fontSize: 25, fontWeight: '600', color: prism.ink, marginTop: 15 }, emptyCopy: { fontSize: 14, lineHeight: 20, textAlign: 'center', color: prism.muted, marginTop: 6 } });
