...
const s=StyleSheet.create({notice:{padding:14,backgroundColor:'#fff4e8',borderRadius:12,marginBottom:12},error:{fontSize:13,color:'#84341f',lineHeight:19},retry:{fontSize:14,fontWeight: '600',color:prism.ink,padding:14,textAlign:'center'},unread:{backgroundColor:prism.accent,borderRadius:20,minWidth:25,padding:5,alignItems:'center'},unreadText:{fontSize:11,color:prism.surface,fontWeight: '600'},safe:{flex:1,backgroundColor:prism.background},center:{flex:1,alignItems:'center',justifyContent:'center'},header:{padding:20,paddingBottom:10},title:{fontSize:31,fontWeight: '500',color:prism.ink},sub:{fontSize:14,color:prism.muted,marginTop:4},list:{padding:18,paddingBottom:30},row:{...prismPanel,borderRadius:20,paddingHorizontal:15,marginBottom:10,flexDirection:'row',alignItems:'center',gap:13,backgroundColor:prism.surface,paddingVertical:15},avatar:{width:50,height:50,borderRadius:25,backgroundColor:prism.soft,alignItems:'center',justifyContent:'center'},name:{fontSize:16,fontWeight: '600',color:prism.ink},preview:{fontSize:13,color:prism.muted,marginTop:5},chev:{fontSize:28,color:prism.accent},empty:{alignItems:'center',paddingTop:100},emptyTitle:{fontSize:25,fontWeight: '600',color:prism.ink,marginTop:15},emptyCopy:{fontSize:14,color:prism.muted,marginTop:6,textAlign:'center'}});
