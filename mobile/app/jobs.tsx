...
const s = StyleSheet.create({ safe: { flex: 1, backgroundColor: prism.background }, headerCopy: { flex: 1, minWidth: 0 }, backButton: { width: 44, height: 44, flexShrink: 0, alignItems: 'center', justifyContent: 'center' }, header: { minHeight: 72, paddingVertical: 10, paddingHorizontal: 18, flexDirection: 'row', alignItems: 'center', gap: 12, borderBottomWidth: 1, borderBottomColor: prism.line, backgroundColor: prism.surface }, back: { fontSize: 36, color: prism.ink }, title: { fontSize: 21, fontWeight: '500', color: prism.ink }, sub: { fontSize: 11, color: prism.muted, marginTop: 2 }, add: { flexShrink: 0, width: 44, height: 44, borderRadius: 14, backgroundColor: prism.ink, alignItems: 'center', justifyContent: 'center' }, addText: { fontSize: 25, color: prism.surface }, wrap: { padding: 18, paddingBottom: 32 }, card: { ...prismPanel, backgroundColor: prism.surface, borderWidth: 1, borderColor: prism.line, borderRadius: 24, padding: 16, marginTop: 14 }, cardTop: { flexDirection: 'row', gap: 10 }, jobTitle: { fontSize: 18, fontWeight: '600', color: prism.ink }, meta: { fontSize: 13, lineHeight: 20, color: prism.muted, marginTop: 6 }, status: { backgroundColor: prism.soft, borderRadius: 99, paddingHorizontal: 10, paddingVertical: 6, alignSelf: 'flex-start' }, statusText: { fontSize: 11, fontWeight: '600', color: '#41713c' }, actions: { flexDirection: 'row', flexWrap: 'wrap', gap: 9, marginTop: 14 }, secondary: { minHeight: 44, justifyContent: 'center', borderWidth: 1, borderColor: prism.line, borderRadius: 11, paddingHorizontal: 15, paddingVertical: 10, alignSelf: 'flex-start' }, secondaryText: { fontWeight: '600', color: prism.ink }, empty: { alignItems: 'center', paddingVertical: 70, paddingHorizontal: 24 }, emptyTitle: { fontSize: 25, fontWeight: '600', color: prism.ink, marginTop: 15 }, primary: { backgroundColor: prism.ink, borderRadius: 13, paddingHorizontal: 20, paddingVertical: 13, marginTop: 20, minHeight: 44 }, primaryText: { color: prism.surface, fontWeight: '600' } });
