...
const s = StyleSheet.create({
  safe: { flex: 1, backgroundColor: prism.background }, header: { padding: 18, gap: 12, flexDirection: 'row', alignItems: 'center', backgroundColor: prism.surface }, headerCopy: { flex: 1, minWidth: 0 }, title: { fontSize: 24, fontWeight: '500', color: prism.ink }, subtitle: { fontSize: 12, marginTop: 4, color: prism.muted }, settings: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center', flexShrink: 0 }, settingsText: { fontSize: 25, color: prism.ink }, tabs: { flexDirection: 'row', flexWrap: 'wrap', padding: 10, gap: 8 }, tab: { flexGrow: 1, flexBasis: 90, minHeight: 44, padding: 10, alignItems: 'center', justifyContent: 'center', borderRadius: 12, backgroundColor: prism.soft }, selectedTab: { backgroundColor: prism.line }, tabText: { fontSize: 12, fontWeight: '600', color: prism.ink, textAlign: 'center' }, list: { padding: 18, paddingBottom: 32 }, card: { ...prismPanel, padding: 18, marginTop: 14, borderRadius: 24, backgroundColor: prism.surface, borderWidth: 1, borderColor: prism.line }, name: { fontSize: 20, fontWeight: '600', color: prism.ink }, meta: { fontSize: 13, color: prism.muted, marginTop: 6 }, copy: { fontSize: 14, color: prism.muted, lineHeight: 21, marginTop: 8 }, pay: { fontSize: 17, fontWeight: '600', color: '#287443', marginTop: 10 }, barPhoto: { width: '100%', height: 180, borderRadius: 12, marginVertical: 12 }, photo: { width: 72, height: 72, borderRadius: 16, marginBottom: 12 }, actions: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 14 }, primary: { minHeight: 44, justifyContent: 'center', borderRadius: 12, padding: 12, backgroundColor: prism.ink }, primaryText: { fontWeight: '600', color: prism.surface, textAlign: 'center' }, secondary: { minHeight: 44, justifyContent: 'center', borderRadius: 12, padding: 12, borderWidth: 1, borderColor: prism.line, alignSelf: 'flex-start' }, secondaryText: { fontWeight: '600', color: prism.ink, textAlign: 'center' }, disabled: { opacity: .5 }, search: { marginTop: 18, padding: 14, borderRadius: 12, borderWidth: 1, borderColor: prism.line, backgroundColor: prism.surface, fontSize: 16, color: prism.ink }, sectionTitle: { fontSize: 20, fontWeight: '600', color: prism.ink, marginTop: 22 }, detail: { marginTop: 12 }, detailLabel: { fontSize: 12, fontWeight: '600', color: prism.ink }, empty: { paddingVertical: 35, alignItems: 'center' },
});
