...
const s = StyleSheet.create({
  ...
  back: { fontSize: 34, color: prism.ink },
  title: { flex: 1, minWidth: 0, textAlign: "center", fontSize: 19, fontWeight: '700', color: prism.ink },
  ...
  cardTitle: { fontSize: 17, fontWeight: '700', color: prism.ink },
  copy: { fontSize: 13, lineHeight: 19, color: prism.muted, marginTop: 6 },
  row: { flexDirection: "row", alignItems: "center" },
  chev: { fontSize: 28, color: prism.accent },
  password: {
    gap: 10,
    borderTopWidth: 1,
  ...
  secondaryText: { color: prism.ink, fontWeight: '600' },
  dangerZone: { borderTopWidth: 1, borderTopColor: "#f0d4d4", marginTop: 16, paddingTop: 16 },
  dangerTitle: { color: "#8f2020", fontSize: 15, fontWeight: '600' },
  ...
  dangerButtonText: { color: "#9c2626", fontWeight: '600' },
  help: {
    flexDirection: "row",
    gap: 10,
    flexWrap: "wrap",
  ...
  advancedText: { color: prism.muted, fontWeight: "700", fontSize: 13 },
  legalOperator: { textAlign: "center", color: prism.muted, fontSize: 12, marginTop: 8 },
  subscriptionHead: { flexDirection: "row", alignItems: "flex-start", gap: 12 },
  subscriptionIcon: { width: 42, height: 42, borderRadius: 13, backgroundColor: prism.soft, alignItems: "center", justifyContent: "center" },
  subscriptionIconText: { fontSize: 20, fontWeight: '600', color: prism.ink },
  subscriptionCopy: { flex: 1 },
  subscriptionPlan: { marginTop: 6, fontSize: 13, lineHeight: 19, fontWeight: '600', color: prism.ink },
