      ...
      <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ScrollView contentContainerStyle={styles.page} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.brandRow}>
            <Image source={require('../assets/brand-mark.png')} resizeMode="contain" style={styles.logo} />
            <Text style={styles.brand}>Barista<Text style={styles.match}>Match</Text></Text>
          </View>
          <View style={styles.hero}>
            <Text style={styles.title}>Great cafés and{`\n`}great baristas{`\n`}<Text style={styles.titleAccent}>belong together.</Text></Text>
            <Text style={styles.subtitle}>The easiest way for cafés and baristas to find each other.</Text>
            <View style={styles.trustRow}>
              <Text style={styles.trustItem}>⌖  Local matches</Text>
              <Text style={styles.trustItem}>○  Private messaging</Text>
            </View>
          </View>
          <View style={styles.card}>
            <Text style={styles.cardTitle}>Welcome back</Text>
            <Text style={styles.cardCopy}>Log in to continue to BaristaMatch.</Text>
          ...
          <Text style={styles.foot}>Made for the coffee community.</Text>
        </ScrollView>
...
const styles = StyleSheet.create({
  safe:{flex:1,backgroundColor:'#fffdf9'},flex:{flex:1},page:{padding:20,paddingTop:12,paddingBottom:34,overflow:'hidden'},
  glowOne:{position:'absolute',width:260,height:260,borderRadius:130,backgroundColor:'#f5e5d5',opacity:.72,top:-125,right:-105},
  brandRow:{flexDirection:'row',alignItems:'center',gap:8,minHeight:54},logo:{width:43,height:43},brand:{fontSize:23,fontWeight:'900',color:'#321708',letterSpacing:-.8},match:{color:'#b76022'},
