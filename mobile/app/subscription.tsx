...
const styles = StyleSheet.create({
  ...
  headerTitle: { flex: 1, minWidth: 0, textAlign: 'center', fontSize: 18, fontWeight: '600', color: prism.ink },
  headerSpacer: { width: 44, flexShrink: 0 },
  wrap: { paddingHorizontal: 18, paddingTop: 26, paddingBottom: 40 },
  hero: { marginBottom: 20 },
  eyebrow: { fontSize: 10, fontWeight: '600', letterSpacing: 1.7, color: prism.accent },
  title: { marginTop: 8, maxWidth: 330, fontSize: 36, lineHeight: 40, fontWeight: '500', letterSpacing: -0.8, color: prism.ink },
  ...
  freeLabel: { fontSize: 12, fontWeight: '600', letterSpacing: 1.6, color: prism.muted },
  priceRow: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'flex-end' },
  freePrice: { marginTop: 5, fontSize: 38, lineHeight: 42, fontWeight: '500', color: prism.ink },
  ...
  currentText: { fontSize: 9, fontWeight: '600', letterSpacing: 0.7, color: '#4f7445' },
  ...
  checkCircleDark: { backgroundColor: prism.soft },
  check: { fontSize: 12, fontWeight: '600', color: '#4f7445' },
  ...
  freeButtonText: { fontSize: 12, fontWeight: '600', color: prism.muted },
  proCard: { ...prismPanel, position: 'relative', marginBottom: 14, padding: 22, borderRadius: 26 },
  glow: { display: 'none' },
  founderPill: { alignSelf: 'flex-start', marginBottom: 17, paddingHorizontal: 11, paddingVertical: 7, borderRadius: 999, backgroundColor: prism.soft },
  founderText: { fontSize: 9, fontWeight: '600', letterSpacing: 1.1, color: prism.accent },
  proLabel: { fontSize: 12, fontWeight: '600', letterSpacing: 1.8, color: prism.muted },
  proPrice: { marginTop: 4, fontSize: 38, lineHeight: 42, fontWeight: '500', color: prism.ink },
  ...
  proButtonText: { fontSize: 15, fontWeight: '600', color: prism.ink },
  ...
  baristaCopy: { flex: 1 },
  baristaTitle: { fontSize: 14, fontWeight: '600', color: prism.ink },
