...
// Owner requested the exact previous, fixed-size café-photo login on September 13.
// Restore the original layout assertions; retain every other approved assertion.
