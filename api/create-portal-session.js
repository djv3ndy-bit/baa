...
export default async function handler(req, res) {
  ...
  try {
    ...
    const session = await stripe.billingPortal.sessions.create({ customer:billing.stripe_customer_id, return_url:mobile?`${origin(req)}/mobile-billing-return.html?billing=portal`:`${origin(req)}/dashboard.html` });
